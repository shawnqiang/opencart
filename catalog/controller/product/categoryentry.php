<?php 
class ControllerProductCategoryentry extends Controller {  
	public function index() { 
		...
		if ($category_info) {
			...
			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/product/categoryentry.tpl')) {
				$this->template = $this->config->get('config_template') . '/template/product/categoryentry.tpl';
			} else {
