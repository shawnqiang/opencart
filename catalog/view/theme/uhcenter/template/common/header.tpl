...
<?php } ?>
<link rel="stylesheet" type="text/css" href="catalog/view/theme/uhcenter/stylesheet/base.css" />
...
<?php } ?>
<!--[if IE 7]>
<link rel="stylesheet" type="text/css" href="catalog/view/theme/uhcenter/stylesheet/ie7.css" />
<![endif]-->
<!--[if lt IE 7]>
<link rel="stylesheet" type="text/css" href="catalog/view/theme/uhcenter/stylesheet/ie6.css" />
...
<body>
  ...
  <div id="header">
      <div class="wraper">
        ...
        <!--
        <div class="links">
            <a href="<?php echo $home; ?>"><?php echo $text_home; ?></a><a href="<?php echo $wishlist; ?>" id="wishlist_total"><?php echo $text_wishlist; ?></a><a href="<?php echo $account; ?>"><?php echo $text_account; ?></a><a href="<?php echo $cart; ?>"><?php echo $text_cart; ?></a><a href="<?php echo $checkout; ?>"><?php echo $text_checkout; ?></a>
        </div>
        -->
...
<div id="menu">
  ...
  <ul>
    ...
    <li>
      <a href="<?php echo $category['href']; ?>" class="<?php echo ($category['category_id'] == $current_category_id) ? 'active' : ''; ?>"><?php echo $category['name']; ?></a>
