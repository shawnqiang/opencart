	...
	$('#payment-address #button-address').live('click', function() {
		$.ajax({
			...
			beforeSend: function() {
				...
				$('#payment-address #button-address').after('<span class="wait">&nbsp;<img src="catalog/view/theme/sellegance/images/loading.gif" alt="" /></span>');
			},	
			complete: function() {
	...
	$('#shipping-address #button-address').live('click', function() {
		$.ajax({
			...
			beforeSend: function() {
				...
				$('#shipping-address #button-address').after('<span class="wait">&nbsp;<img src="catalog/view/theme/sellegance/images/loading.gif" alt="" /></span>');
			},	
			complete: function() {
	...
	$('#button-shipping').live('click', function() {
		$.ajax({
			...
			beforeSend: function() {
				...
				$('#button-shipping').after('<span class="wait">&nbsp;<img src="catalog/view/theme/sellegance/images/loading.gif" alt="" /></span>');
			},	
			complete: function() {
	...
	$('#button-payment').live('click', function() {
		$.ajax({
			...
			beforeSend: function() {
				...
				$('#button-payment').after('<span class="wait">&nbsp;<img src="catalog/view/theme/sellegance/images/loading.gif" alt="" /></span>');
			},	
			complete: function() {
