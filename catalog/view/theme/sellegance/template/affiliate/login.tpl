<?php echo $header; ?>
	...
	<div id="maincontent" class="grid_10 push_1">
		...
		<div class="grid_5 alpha">
			...
			<div class="contentset center"><div class="inner"><span><?php echo $text_new_affiliate; ?></span></div></div>
		...
		<div class="grid_5 omega">
			...
			<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="login">
				...
				<div class="contentset center"><div class="inner"><span><?php echo $text_returning_affiliate; ?></span></div></div>
