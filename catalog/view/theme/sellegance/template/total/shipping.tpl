<div id="shipping">
	...
	<div class="field_row">
		...
		<input type="text" name="postcode" value="" size="30" />
	</div>
	
    <div class="">
    	<a id="button-quote" class="button black small"><span><?php echo $button_quote; ?></span></a>
	...
	$.ajax({
		...
		success: function(json) {
			...
			if (json['shipping_methods']) {
				...
				html += '</table>';
				html += '<br /><a id="button-shipping" class="button black small"><span><?php echo $button_shipping; ?></span></a>';				
...
$('#button-shipping').live('click', function() {
	$.ajax({
		...
		success: function(json) {
			if (json['error']) {
				$('#shipping').before('<div class="warning">' + json['error'] + '<img src="catalog/view/theme/sellegance/images/close.png" alt="" class="close" /></div>');
			}
