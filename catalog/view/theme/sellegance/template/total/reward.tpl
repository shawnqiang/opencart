<div>
  ...
  &nbsp;<a id="button-reward" class="button black small"><span><?php echo $button_reward; ?></a></div>
</div>
...
$('#button-reward').bind('click', function() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#button-reward').after('<span class="wait">&nbsp;<img src="catalog/view/theme/sellegance/images/loading.gif" alt="" /></span>');
		},
		complete: function() {
