...
class ControllerModuleSellegance extends Controller {
    ...
    public function index() {   
        ...
        if (isset($this->request->post['sellegance_module'])) {
            $modules = explode(',', $this->request->post['sellegance_module']);
        } elseif ($this->config->get('sellegance_module') != '') {
            $modules = explode(',', $this->config->get('sellegance_module'));
        } else {
            $modules = array();
        }           
        ...
        foreach ($modules as $module) {
            if (isset($this->request->post['sellegance_' . $module . '_layout_id'])) {
                $this->data['sellegance_' . $module . '_layout_id'] = $this->request->post['sellegance_' . $module . '_layout_id'];
            } else {
                $this->data['sellegance_' . $module . '_layout_id'] = $this->config->get('sellegance_' . $module . '_layout_id');
            }   
            
            if (isset($this->request->post['sellegance_' . $module . '_position'])) {
                $this->data['sellegance_' . $module . '_position'] = $this->request->post['sellegance_' . $module . '_position'];
            } else {
                $this->data['sellegance_' . $module . '_position'] = $this->config->get('sellegance_' . $module . '_position');
            }   
            
            if (isset($this->request->post['sellegance_' . $module . '_status'])) {
                $this->data['sellegance_' . $module . '_status'] = $this->request->post['sellegance_' . $module . '_status'];
            } else {
                $this->data['sellegance_' . $module . '_status'] = $this->config->get('sellegance_' . $module . '_status');
            }   
                        
            if (isset($this->request->post['sellegance_' . $module . '_sort_order'])) {
                $this->data['sellegance_' . $module . '_sort_order'] = $this->request->post['sellegance_' . $module . '_sort_order'];
            } else {
                $this->data['sellegance_' . $module . '_sort_order'] = $this->config->get('sellegance_' . $module . '_sort_order');
            }               
        }
